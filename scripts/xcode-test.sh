...
if [ $PLATFORM == "iOS" -a $OS == "12.4" ]; then
    ...
    env NSUnbufferedIO=YES xcodebuild -workspace Sentry.xcworkspace \
        ...
        -skip-testing:"SentryTests/BuzzSentrySDKTests/testMemoryFootprintOfAddingBreadcrumbs" \
        -skip-testing:"SentryTests/BuzzSentrySDKTests/testMemoryFootprintOfTransactions" \
