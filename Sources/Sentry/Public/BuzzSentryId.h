 ...
 * cases.
 */
@interface BuzzSentryId : NSObject

/**
 * Creates a BuzzSentryId with a random BuzzSentryId.
 */
- (instancetype)init;

/**
 * Creates a BuzzSentryId with the given UUID.
 */
- (instancetype)initWithUUID:(NSUUID *)uuid;

/**
 * Creates a BuzzSentryId from a 32 character hexadecimal string without dashes such as
 ...
 *
 * @return BuzzSentryId.empty for invalid strings.
 */
 ...
 */
@property (class, nonatomic, readonly, strong) BuzzSentryId *empty;
