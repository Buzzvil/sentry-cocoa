...
@class BuzzSentryDsn, BuzzSentrySDKInfo, BuzzSentryMeasurementValue, BuzzSentryHttpStatusCodeRange;
 ...
 * Defaults to 500 - 599.
 */
@property (nonatomic, strong) NSArray<BuzzSentryHttpStatusCodeRange *> *failedRequestStatusCodes;
