...
// files, arranged for use in BuzzSentryCrashObjC.

#ifndef HDR_BuzzSentryCrashObjCApple_h
#define HDR_BuzzSentryCrashObjCApple_h
...
// BuzzSentryCrash: The original values wouldn't have worked. The slot shift and
// mask were incorrect.
#    define TAG_COUNT 8
...
#endif // HDR_BuzzSentryCrashObjCApple_h
